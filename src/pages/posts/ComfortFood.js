  ...
  const recipes = [
    {
      ...
      image: '/images/macaroni-cheese.jpg',
      rating: 4.9,
      reviews: 300,
      cookTime: '30 mins',
      difficulty: 'easy',
      author: 'Chef Lisa',
      description: 'A classic comfort food that everyone loves.',
    },
    {
      id: 'beef-stroganoff',
      ...
      difficulty: 'medium',
      author: 'Chef John',
      description: 'Tender beef in a creamy sauce served over noodles.',
    },
  ...
  return (
    <div className="post-container">
      <div className="post-header">
        <h1>Comfort Food</h1>
        <p>Hearty meals that warm the soul!</p>
      </div>
