  ...
  const recipes = [
    {
      ...
      image: '/images/slow-cooker-chili.jpg',
      rating: 4.9,
      reviews: 1500,
      cookTime: '6 hours',
      difficulty: 'easy',
    ...
    },
    {
      ...
      image: '/images/slow-cooker-pot-roast.jpg',
      rating: 4.8,
      reviews: 1200,
      cookTime: '8 hours',
      difficulty: 'medium',
    ...
    // Add more Slow Cooker recipes as needed
  ];
      ...
      <div className="post-header">
        <div className="header-content">
          ...
          <p className="header-description">
            Discover delicious Slow Cooker recipes that are easy to prepare.
          </p>
        </div>
      </div>
...
export default SlowCookerRecipes; 