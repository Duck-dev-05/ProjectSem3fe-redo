...
import './DinnerBrunch.css'; // Create this CSS file for styling
      ...
      <div className="post-header">
        <div className="header-content">
          ...
          <p className="header-description">
            Discover a variety of delicious dinner recipes that are perfect for any occasion.
          </p>
        </div>
      </div>
